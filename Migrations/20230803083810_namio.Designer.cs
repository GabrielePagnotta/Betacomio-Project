...
namespace Betacomio_Project.Migrations
{
    ...
    [Migration("20230803083810_namio")]
    partial class namio
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Betacomio_Project.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("Betacomio_Project.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("Betacomio_Project.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Betacomio_Project.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("Betacomio_Project.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("Betacomio_Project.Models.CustomerAddress", b =>
                {
                    b.HasOne("Betacomio_Project.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("Betacomio_Project.Models.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.Product", b =>
                {
                    b.HasOne("Betacomio_Project.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("Betacomio_Project.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ProductCategory", b =>
                {
                    b.HasOne("Betacomio_Project.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("Betacomio_Project.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("Betacomio_Project.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("Betacomio_Project.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("Betacomio_Project.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("Betacomio_Project.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("Betacomio_Project.Models.Address", "ShipToAddress")
